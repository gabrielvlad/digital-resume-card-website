      ...
      <div className="aboutmain uk-flex uk-flex-center uk-flex-middle uk-flex-column">
        <Fade delay={400}>
          ...
          <div>
            <Hover>
              <a
                href="https://www.linkedin.com/in/gabrielvlad22/"
                target="_blank"
              >
                <Icon
            ...
            <Hover>
              <a href="https://twitter.com/gabrielvlad22" target="_blank">
                <Icon
                  icon="logos:twitter"
            ...
            <Hover>
              <a href="https://github.com/gabrielvlad" target="_blank">
                <Icon
            ...
            <Hover>
              <a href="./resume as pdf file" download="gabriel-vlad-resume.pdf">
                <Icon
